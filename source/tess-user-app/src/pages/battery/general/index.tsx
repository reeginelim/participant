    ...
    <PageContainer>
      <Card bordered={false}>
        <Descriptions title="Battery Storage" style={{ marginBottom: 32 }}>
          ...
          <Descriptions.Item label="Charging"><Switch checkedChildren="On" unCheckedChildren="Off" defaultChecked /> <Switch checkedChildren="MAN" unCheckedChildren="AUTO" defaultChecked /></Descriptions.Item>
        ...
        <h3>Flexibility: </h3><Slider marks={marks} defaultValue={30} tooltip={{ open: true }} />
